...
/**
 *The GameSaved Phase extends the phase class and implements all the methods suitable for that particular phase.
...
public class GameSaved extends Phase {
	...
	/**
	 * This is the constructor of GameSaved which initializes Game engine object and command prompt object and assigning log entry buffer
