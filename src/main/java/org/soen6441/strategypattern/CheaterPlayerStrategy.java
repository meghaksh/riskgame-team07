...
public class CheaterPlayerStrategy extends Strategy implements Serializable {
	...
	public Order createOrder() {
		...
		case 1: 
			...
			{
				d_Leb.setResult("in cheater defending country - "+l_Countries.get(0).getCountryName()+" Attacking country - "+l_Countries.get(1).getCountryName()+" with armies - "+(l_Countries.get(0).getNoOfArmies()-1));
